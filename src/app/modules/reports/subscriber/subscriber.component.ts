...
export class SubscriberComponent implements OnInit {
  ...
  getReports(value?: any, fromDate?: any, toDate?: any) {
    ...
    this.reportService.getSubscriberGraphReport(value, fromDate, toDate).subscribe(
      (res: any) => {
        if (res.result) {
          const labelData: any[] = [];
  ...
  downloadReport() {
    ...
    this.reportService
      .getSubscriberDownloadReport(timeFrame, this.startDate, this.endDate)
      .subscribe((res: any) => {
  ...
  sendSubscriberReportEmail() {
    ...
    this.reportService.sendSubscriberReportEmail(timeFrame, this.startDate, this.endDate).subscribe(
      (res: any) => {
        this.dialogService
          .openModal(ReportSuccessInfoComponent, {
            cssClass: 'modal-sm',
